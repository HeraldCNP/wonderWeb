...
<head>
    ...
    <title>WonderGroup - Administración</title>

    <meta name="description" content="Administracion del sistema de wonder">
...
<div id="page-wrapper">
    ...
    <div class="preloader themed-background">
        <h1 class="push-top-bottom text-light text-center"><strong>Wonder</strong>Group</h1>
        <div class="inner">
    ...
    <div id="page-container" class="sidebar-partial sidebar-visible-lg sidebar-no-animations themed-background-dark-night themed-border-night">
        ...
        <div id="sidebar">
            ...
            <div id="sidebar-scroll">
                <!-- Sidebar Content -->
                <div class="sidebar-content themed-background-dark-night themed-border-night">
                    <!-- Brand -->
                    ...
                    <div class="sidebar-section sidebar-user clearfix sidebar-nav-mini-hide">
                        <div class="sidebar-user-avatar">
                            <a href="index.html">
                                <img src="{{ asset('admin/img/placeholders/avatars/avatar.jpg') }}" alt="avatar">
                            </a>
                        </div>
        ...
        <div id="main-container">
            ...
            <header class="navbar navbar-default">
                ...
                <ul class="nav navbar-nav-custom">
                    ...
                    <!-- Template Options -->
                    <!-- Change Options functionality can be found in admin/js/app.js - templateOptions() -->
                    <li class="dropdown">
                ...
                <ul class="nav navbar-nav-custom pull-right">
                    ...
                    <li class="dropdown">
                        <a href="javascript:void(0)" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="{{ asset('admin/img/placeholders/avatars/avatar.jpg') }}" alt="avatar"> <i class="fa fa-angle-down"></i>
                        </a>
